<template>
  <div class="min-h-screen bg-[var(--md-sys-color-background)] text-[var(--md-sys-color-on-background)] pb-20">
    ...
    <div class="container mx-auto px-6 md:px-24">
      <div v-for="(team, teamIndex) in teams" :key="teamIndex" class="mb-20">
          ...
          <div v-for="(member, memberIndex) in team.list" :key="memberIndex"
            ...
            <div class="flex flex-col items-center">
              ...
              <div class="text-center w-full">
                ...
                <div
                    class="inline-block px-3 py-1 rounded-full bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)] text-xs font-semibold uppercase tracking-wider mb-4">
                  {{ member.position }}
                </div>
                ...
                <div
                  ...
                  <a v-if="member.contact?.github" :href="'https://github.com/'+member.contact.github" target="_blank"
...
import {teams, type TeamMember} from '~/contributors';
