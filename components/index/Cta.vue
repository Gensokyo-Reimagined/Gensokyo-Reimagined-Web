<template>
  ...
  <div v-if="appConfig.IPCtaShow" class="bg-[var(--md-sys-color-background)]">
    <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-[var(--md-sys-color-error)] rounded-lg shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
        <div class="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
          <img :src="appConfig.IndexIPCtaImg" alt="App screenshot"
               class="object-cover object-left-top transform translate-x-6 translate-y-6 rounded-md sm:translate-x-16 lg:translate-y-20"
               height="300" loading="lazy" width="400"/>
        </div>
        <div class="px-6 pt-10 pb-12 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:pl-10 xl:pr-4">
          <div class="lg:self-center">
            <h2 class="text-3xl font-extrabold text-[var(--md-sys-color-on-error)] sm:text-4xl">
							<span class="block">
								{{ $t('index.IPcta.title') }}
							</span>
              <!-- <span class="block">
            ...
            <p>
							<span class="mr-8 text-lg leading-6 text-[var(--md-sys-color-error-container)]">
              ...
              <button
                ...
                <i class="fa-solid fa-copy ml-3 -mr-1"/>
              </button>
            </p>
            <p>
							<span class="mr-8 text-lg leading-6 text-[var(--md-sys-color-error-container)]">
  ...
  <div v-if="appConfig.DCCtaShow" class="bg-[var(--md-sys-color-background)]">
    <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-[var(--md-sys-color-error)] rounded-lg shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
        ...
        <div class="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
          <img :src="appConfig.IndexCtaImg" alt="App screenshot"
               class="object-cover object-left-top transform translate-x-6 translate-y-6 rounded-md sm:translate-x-16 lg:translate-y-20"
               height="300" loading="lazy" width="400"/>
        </div>
      </div>
  ...
  <div v-if="appConfig.MPCtaShow" class="bg-[var(--md-sys-color-background)]">
    <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-[var(--md-sys-color-error)] rounded-lg shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
        <div class="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
          <img :src="appConfig.IndexModPackCtaImg" alt="App screenshot"
               class="object-cover object-left-top transform translate-x-6 translate-y-6 rounded-md sm:translate-x-16 lg:translate-y-20"
               height="300" loading="lazy" width="400"/>
        </div>
        <div class="px-6 pt-10 pb-12 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
