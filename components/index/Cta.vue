<template>
  <div class=" bg-[var(--md-sys-color-background)]">
    <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-red-700 rounded-lg shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
        <div class="px-6 pt-10 pb-12 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
          <div class="lg:self-center">
            ...
            <a href="https://discord.gg/U9fZSJJcte" target="_blank"
              class="inline-flex items-center px-5 py-3 mt-8 text-base font-medium text-red-600  bg-[var(--md-sys-color-background)] border border-transparent rounded-md shadow hover:bg-red-50">
              {{ $t('index.cta.button') }}
